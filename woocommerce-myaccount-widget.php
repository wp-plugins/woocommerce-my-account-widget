...
{	
	...
	if(is_multisite()) { $woo_ma_home=network_home_url(); } else {$woo_ma_home=home_url();}
		...
		$args = array(
			'echo' => true,
			'form_id' => 'loginform',
			'label_username' => __('Username','woocommerce-myaccount-widget'),
			'label_password' => __('Password','woocommerce-myaccount-widget'),
			'label_remember' => __('Remember Me','woocommerce-myaccount-widget'),
			'label_log_in' => __('Log In','woocommerce-myaccount-widget'),
